...
생성자 함수의 역할은 인스턴스를 생성하는 것과 생성된 인스턴르츷 초기화 하는 것이다.
...
> 참고로 대부분의 빌트인 생성자 함수(Object, String, Number, Boolean, Function, Array, Date, RegExp, Promise 등)는 new 연산자와 함께 호출되었는지를 확인할 수 적절한 값을 반환한다.
